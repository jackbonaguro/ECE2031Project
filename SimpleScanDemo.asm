...
Main:
	...
	ADDI DataArray	;get index of distance
	STORE ArrayIndex	;store
	ILOAD ArrayIndex	;load distance into AC
	ADDI -254;
	STORE Target	;store
	OUT SSEG1;
	...
	;Loop checks if distance is greater than target
CheckDistance:
	IN XPOS
	OUT SSEG2
	SUB Target
...
Target:	  DW 0 ; Target distance when to stop
Curr:	  DW 0 ; Current distance
